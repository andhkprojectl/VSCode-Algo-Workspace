...
def isDoTrade(currDateTImeUSCentral):
    ...
    if currDateTImeUSCentral.weekday() == 6 \
           and (currDateTImeUSCentral.hour == 20 and (currDateTImeUSCentral.minute == 0 or currDateTImeUSCentral.minute == 5 or currDateTImeUSCentral.minute == 30) and currDateTImeUSCentral.second >= 1 and currDateTImeUSCentral.second <= 30):
            result1 = True
    # True if Fri
    ...
    elif (currDateTImeUSCentral.weekday() == 0 or currDateTImeUSCentral.weekday() == 1 or currDateTImeUSCentral.weekday() == 2 or currDateTImeUSCentral.weekday() == 3 or currDateTImeUSCentral.weekday() == 4) \
            and (currDateTImeUSCentral.hour == 0 and (currDateTImeUSCentral.minute == 0 or currDateTImeUSCentral.minute == 5 or currDateTImeUSCentral.minute == 30) and currDateTImeUSCentral.second >= 1 and currDateTImeUSCentral.second <= 30):
            result1 = True
    # test
...
def run_amibroker_analysis():
    ...
    try:
        ...
        apx_file_path_ZS = "C:\\Project\\ProjectLife\\amibroker\\system\\PL_TD_Ema_20241023_1.0.0_S\\5 Incubation\\inCubation_ZS.apx"
